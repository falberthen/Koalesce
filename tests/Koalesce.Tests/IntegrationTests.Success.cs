...
public partial class IntegrationTests : KoalesceIntegrationTestBase
{
	...
	[Fact]
	public async Task Koalesce_ShouldMergeOpenAPIRoutes()
	{
		// Arrange & Act
	...
	[Fact]
	public async Task Koalesce_ShouldReturnValidOpenApiSchema()
	{
		// Arrange & Act
		var koalescingApi = await StartWebApplicationAsync(_appSettings,
			builder => builder.Services
	...
	[Fact]
	public async Task Koalesce_ShouldIncludeCorrectServerUrls()
	{
		// Arrange & Act
		var koalescingApi = await StartWebApplicationAsync(_appSettings,
			builder => builder.Services
	...
	[Fact]
	public async Task Koalesce_ShouldContainTopLevelServers()
	{
		// Arrange & Act
		var koalescingApi = await StartWebApplicationAsync(_appSettings,
			builder => builder.Services
	...
	[Fact]
	public async Task Koalesce_ShouldEnsureEachPathHasServers()
	{
		// Arrange & Act
		var koalescingApi = await StartWebApplicationAsync(_appSettings,
			builder => builder.Services
	...
	[Fact]
	public async Task Koalesce_ShouldContainTagsPerPathWhenTagProvided()
	{
		// Arrange & Act
		var koalescingApi = await StartWebApplicationAsync(_appSettings,
			builder => builder.Services
	...
	[Fact]
	public async Task Koalesce_ShouldPreserveDownstreamSecuritySchemes()
	{
		// Arrange & Act
		var koalescingApi = await StartWebApplicationAsync(_appSettings,
			builder => builder.Services
	...
	[Fact]
	public async Task Koalesce_WhenSchemaConflictOccurs_ShouldRenameOnlySourceWithVirtualPrefix()
	{
		// Arrange & Act
		var koalescingApi = await StartWebApplicationAsync(_appSettings,
			builder => builder.Services
		...
		// Assert: Default pattern is {Prefix}{SchemaName}
		...
		Assert.Contains("\"InventoryProduct\"", mergedResult); // Inventory API (with VirtualPrefix) is renamed

		// Verify the reference was updated
		Assert.Contains("#/components/schemas/InventoryProduct", mergedResult);

		await koalescingApi.StopAsync();
	}

	[Fact]
	public async Task Koalesce_WhenBothSourcesHaveVirtualPrefix_ShouldRenameBothConflictingSchemas()
	{
		// Arrange & Act
		...
		Assert.Contains("\"ProductsProduct\"", mergedResult);
		Assert.Contains("\"InventoryProduct\"", mergedResult);
	...
	[Fact]
	public async Task Koalesce_WhenOnlyFirstSourceHasVirtualPrefix_ShouldRenameFirstAndKeepSecondOriginal()
	{
		// Arrange & Act
		...
		Assert.Contains("\"ProductsProduct\"", mergedResult);  // Products API (with VirtualPrefix) is renamed
	...
	[Fact]
	public async Task Koalesce_WhenSchemaConflictPatternIsCustomized_ShouldRenameSchemaWithCustomPattern()
	{
	...
	[Fact]
	public async Task Koalesce_WhenExcludePathsConfigured_ShouldNotIncludeExcludedPaths()
	{
		// Arrange & Act
	...
	[Fact]
	public async Task Koalesce_WhenExcludePathsWithWildcard_ShouldExcludeMatchingPaths()
	{
		// Arrange & Act
		var koalescingApi = await StartWebApplicationAsync(_appSettings,
			builder => builder.Services
	...
	[Fact]
	public async Task Koalesce_WhenFailOnLoadErrorIsFalse_AndSourceIsUnreachable_ShouldSkipSourceAndReturnPartialResult()
	{
		// Arrange & Act
	...
	[Fact]
	public async Task Koalesce_WhenFailOnLoadErrorIsTrue_AndSourceIsUnreachable_ShouldReturnInternalServerError()
	{
		// Arrange & Act
	...
	[Fact]
	public async Task Koalesce_WithFilePathSource_ShouldMergeFileBasedSpec()
	{
		// Arrange & Act
	...
	[Fact]
	public async Task Koalesce_WithFilePathSource_ShouldIncludeSchemasFromFile()
	{
		// Arrange & Act
		var koalescingApi = await StartWebApplicationAsync(_filePathSettings,
			builder => builder.Services
	...
	[Fact]
	public async Task Koalesce_WithFilePathSource_ShouldIncludeTagsFromFile()
	{
		// Arrange & Act
		var koalescingApi = await StartWebApplicationAsync(_filePathSettings,
			builder => builder.Services
	...
	[Fact]
	public async Task Koalesce_WithMixedSources_ShouldMergeHttpAndFileSources()
	{
		// Arrange & Act
	...
	[Fact]
	public async Task Koalesce_WithFilePathSource_ShouldPreserveServersFromSourceDocument()
	{
		// Arrange & Act
