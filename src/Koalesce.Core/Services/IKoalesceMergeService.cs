...
{
	/// <summary>
	/// Merges API specifications and returns a detailed result including load status for each source.
	/// </summary>
	...
	Task<MergeResult> MergeSpecificationsAsync(string? outputPath = null);
}
